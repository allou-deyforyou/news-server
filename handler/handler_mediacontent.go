...
func (h *Handler) MediaContent(w http.ResponseWriter, r *http.Request) {
	...
	// Fetch
	post := sourceParsed.MediaContent(context, link)
	// Response
	ProtoEncode(w, &custom.MediaPostResponse{Data: post})
}
