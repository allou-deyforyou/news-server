...
//		GroupBy(categories.FieldArticleCategories).
...
//
//	client.Categories.Query().
//		Select(categories.FieldArticleCategories).
//		Scan(ctx, &v)
//
...
func (cgb *CategoriesGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("storage: CategoriesGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *CategoriesGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{categories.Label}
	default:
		err = fmt.Errorf("storage: CategoriesGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *CategoriesGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("storage: CategoriesGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *CategoriesGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{categories.Label}
	default:
		err = fmt.Errorf("storage: CategoriesGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *CategoriesGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("storage: CategoriesGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *CategoriesGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{categories.Label}
	default:
		err = fmt.Errorf("storage: CategoriesGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (cgb *CategoriesGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(cgb.fields) > 1 {
		return nil, errors.New("storage: CategoriesGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := cgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cgb *CategoriesGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{categories.Label}
	default:
		err = fmt.Errorf("storage: CategoriesGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *CategoriesSelect) Strings(ctx context.Context) ([]string, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("storage: CategoriesSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *CategoriesSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{categories.Label}
	default:
		err = fmt.Errorf("storage: CategoriesSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *CategoriesSelect) Ints(ctx context.Context) ([]int, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("storage: CategoriesSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *CategoriesSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{categories.Label}
	default:
		err = fmt.Errorf("storage: CategoriesSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *CategoriesSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("storage: CategoriesSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *CategoriesSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{categories.Label}
	default:
		err = fmt.Errorf("storage: CategoriesSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (cs *CategoriesSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(cs.fields) > 1 {
		return nil, errors.New("storage: CategoriesSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := cs.Scan(ctx, &v); err != nil {
		return nil, err
...
func (cs *CategoriesSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{categories.Label}
	default:
		err = fmt.Errorf("storage: CategoriesSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
