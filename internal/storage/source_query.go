...
//
//	client.Source.Query().
//		GroupBy(source.FieldArticleFeaturedPostSelector).
...
//
//	client.Source.Query().
//		Select(source.FieldArticleFeaturedPostSelector).
//		Scan(ctx, &v)
//
func (sq *SourceQuery) Select(fields ...string) *SourceSelect {
	sq.fields = append(sq.fields, fields...)
	return &SourceSelect{SourceQuery: sq}
}
...
func (sgb *SourceGroupBy) Strings(ctx context.Context) ([]string, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("storage: SourceGroupBy.Strings is not achievable when grouping more than 1 field")
	}
	var v []string
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *SourceGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{source.Label}
	default:
		err = fmt.Errorf("storage: SourceGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (sgb *SourceGroupBy) Ints(ctx context.Context) ([]int, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("storage: SourceGroupBy.Ints is not achievable when grouping more than 1 field")
	}
	var v []int
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *SourceGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{source.Label}
	default:
		err = fmt.Errorf("storage: SourceGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (sgb *SourceGroupBy) Float64s(ctx context.Context) ([]float64, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("storage: SourceGroupBy.Float64s is not achievable when grouping more than 1 field")
	}
	var v []float64
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *SourceGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{source.Label}
	default:
		err = fmt.Errorf("storage: SourceGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (sgb *SourceGroupBy) Bools(ctx context.Context) ([]bool, error) {
	if len(sgb.fields) > 1 {
		return nil, errors.New("storage: SourceGroupBy.Bools is not achievable when grouping more than 1 field")
	}
	var v []bool
	if err := sgb.Scan(ctx, &v); err != nil {
		return nil, err
...
func (sgb *SourceGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{source.Label}
	default:
		err = fmt.Errorf("storage: SourceGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *SourceSelect) Strings(ctx context.Context) ([]string, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("storage: SourceSelect.Strings is not achievable when selecting more than 1 field")
	}
	var v []string
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *SourceSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{source.Label}
	default:
		err = fmt.Errorf("storage: SourceSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *SourceSelect) Ints(ctx context.Context) ([]int, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("storage: SourceSelect.Ints is not achievable when selecting more than 1 field")
	}
	var v []int
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *SourceSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{source.Label}
	default:
		err = fmt.Errorf("storage: SourceSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *SourceSelect) Float64s(ctx context.Context) ([]float64, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("storage: SourceSelect.Float64s is not achievable when selecting more than 1 field")
	}
	var v []float64
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *SourceSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{source.Label}
	default:
		err = fmt.Errorf("storage: SourceSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ss *SourceSelect) Bools(ctx context.Context) ([]bool, error) {
	if len(ss.fields) > 1 {
		return nil, errors.New("storage: SourceSelect.Bools is not achievable when selecting more than 1 field")
	}
	var v []bool
	if err := ss.Scan(ctx, &v); err != nil {
		return nil, err
...
func (ss *SourceSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{source.Label}
	default:
		err = fmt.Errorf("storage: SourceSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
