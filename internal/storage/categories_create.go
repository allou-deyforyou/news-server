...
func (cc *CategoriesCreate) SetArticleCategories(m map[string]string) *CategoriesCreate {
	cc.mutation.SetArticleCategories(m)
	return cc
}

// SetMediaCategories sets the "media_categories" field.
func (cc *CategoriesCreate) SetMediaCategories(m map[string]string) *CategoriesCreate {
	cc.mutation.SetMediaCategories(m)
	return cc
}

// SetLanguage sets the "language" field.
func (cc *CategoriesCreate) SetLanguage(s string) *CategoriesCreate {
	cc.mutation.SetLanguage(s)
	return cc
}

// SetNillableLanguage sets the "language" field if the given value is not nil.
func (cc *CategoriesCreate) SetNillableLanguage(s *string) *CategoriesCreate {
	if s != nil {
		cc.SetLanguage(*s)
	}
	return cc
...
func (cc *CategoriesCreate) SetStatus(b bool) *CategoriesCreate {
	cc.mutation.SetStatus(b)
	return cc
}

// SetNillableStatus sets the "status" field if the given value is not nil.
func (cc *CategoriesCreate) SetNillableStatus(b *bool) *CategoriesCreate {
	if b != nil {
		cc.SetStatus(*b)
	}
	return cc
...
func (cc *CategoriesCreate) defaults() {
	if _, ok := cc.mutation.Language(); !ok {
		v := categories.DefaultLanguage
		cc.mutation.SetLanguage(v)
	}
	if _, ok := cc.mutation.Status(); !ok {
		v := categories.DefaultStatus
...
func (cc *CategoriesCreate) check() error {
	if _, ok := cc.mutation.Language(); !ok {
		return &ValidationError{Name: "language", err: errors.New(`storage: missing required field "Categories.language"`)}
	}
	if _, ok := cc.mutation.Status(); !ok {
		return &ValidationError{Name: "status", err: errors.New(`storage: missing required field "Categories.status"`)}
	}
	return nil
}
...
func (cc *CategoriesCreate) createSpec() (*Categories, *sqlgraph.CreateSpec) {
	...
	if value, ok := cc.mutation.ArticleCategories(); ok {
	...
	if value, ok := cc.mutation.MediaCategories(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeJSON,
			Value:  value,
