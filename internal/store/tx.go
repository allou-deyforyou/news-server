...
func (tx *Tx) init() {
	tx.NewsSource = NewNewsSourceClient(tx.config)
	tx.TvSource = NewTvSourceClient(tx.config)
}
...
// applies a query, for example: NewsSource.QueryXXX(), the query will be executed
